...
/** @class */
function () {
  function Exchanger(dollar, euro, frank) {
    this.dollar = dollar;
    this.euro = euro;
    this.frank = frank;
  }

  Exchanger.prototype.toDollar = function () {
    var dollar = Math.round(this.dollar * 4.27 * 100) / 100;
    return dollar;
  };

  Exchanger.prototype.toEuro = function () {
    var euro = Math.round(this.euro * 4.57 * 100) / 100;
    return euro;
  };

  Exchanger.prototype.toFrank = function () {
    var frank = Math.round(this.frank * 4.3 * 100) / 100;
    return frank;
  };
  ...
  if (btn !== null) {
    if (btn instanceof HTMLButtonElement) {
      btn.addEventListener("click", function (event) {
        ...
        var ex = new Exchanger_1.Exchanger(getDollar(), getEuro(), getFrank());
...
},{}]},{},["../node_modules/parcel-bundler/src/builtins/hmr-runtime.js","../src/Setup.ts"], null)
//# sourceMappingURL=/Setup.e0489641.js.map